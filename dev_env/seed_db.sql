...
-- Password hash is for 'testpassword123' using scrypt (Better Auth parameters: N=16384, r=16, p=1, dkLen=64)
-- Format: salt:hash (both hex encoded, salt passed as string to scrypt)
INSERT INTO auth_account (id, user_id, account_id, provider_id, password, created_at, updated_at)
VALUES
  ('test-account-member-00000000001', 'test-member-id-000000000000000001', 'test-member-id-000000000000000001', 'credential', 'a1b2c3d4e5f6a7b8a1b2c3d4e5f6a7b8:05891b04ad22fe3cc64671a93657e9503e08bbe12193287ebc6944d4b3c12ef16e4a796f4f723920798e9911ae21306009e92b6a1f79d155835085e7efd77aa8', NOW(), NOW()),
  ('test-account-dj1-000000000001', 'test-dj1-id-00000000000000000001', 'test-dj1-id-00000000000000000001', 'credential', 'a1b2c3d4e5f6a7b8a1b2c3d4e5f6a7b8:05891b04ad22fe3cc64671a93657e9503e08bbe12193287ebc6944d4b3c12ef16e4a796f4f723920798e9911ae21306009e92b6a1f79d155835085e7efd77aa8', NOW(), NOW()),
...
INSERT INTO wxyc_schema.artists(artist_name, alphabetical_name, code_letters)
	VALUES ('Ravyn Lenae', 'Ravyn Lenae', 'LE');
...
INSERT INTO wxyc_schema.artists(artist_name, alphabetical_name, code_letters)
	VALUES ('Sufjan Stevens', 'Sufjan Stevens', 'ST');

INSERT INTO wxyc_schema.artists(artist_name, alphabetical_name, code_letters)
	VALUES ('Kendrick Lamar', 'Kendrick Lamar', 'LA');
