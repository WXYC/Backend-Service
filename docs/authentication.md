...
| musicDirector  | read/write | read/write | read/write + manage                           |
| stationManager | read/write | read/write | read/write + manage (plus org administration) |
