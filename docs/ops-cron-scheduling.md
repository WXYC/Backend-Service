...
| 00:47 / 06:47 / 12:47 / 18:47 | `flowsheet-no-match-recheck`              | **heavy drain** (large `enriched_no_match` cohort, per-row `lookupMetadata`; TTL-gated + `FLOWSHEET_NO_MATCH_RECHECK_BATCH_SIZE`-bounded drip, BS#2176) |
