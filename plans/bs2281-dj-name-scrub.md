...
- Cohort C policy.
- Converting the two live SQL re-derivers to the canonical helper (wire-behaviour change; own issue, own evidence). Tracked as a follow-up (BS#2313), and this plan is explicitly incomplete without it.
