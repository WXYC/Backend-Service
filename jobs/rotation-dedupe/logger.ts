/**
 * Observability for rotation-dedupe: Sentry init + JSON logs.
 *
 ...
 * is identical, the duplication is to keep the one-shot job's build graph
 * independent of the long-running ETL packages.
 */
