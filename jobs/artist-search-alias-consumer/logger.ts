/**
 * Observability for artist-search-alias-consumer: Sentry init + JSON logs.
 *
 ...
 *
 * Mirrors `jobs/library-identity-consumer/logger.ts` verbatim — the contract
 * is identical, the duplication is to keep the cron job's build graph
