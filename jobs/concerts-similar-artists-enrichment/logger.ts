/**
 * Observability for concerts-similar-artists-enrichment: Sentry init + JSON logs.
 *
 ...
 *
 * Mirrors `jobs/concerts-genre-enrichment/logger.ts` verbatim — the contract is
 * identical, and the duplication is the established pattern for keeping each
 * job's build graph independent of the others.
 */
