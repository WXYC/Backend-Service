/**
 * Observability for legacy-linkage-resolve: Sentry init + JSON logs.
 *
 * Mirrors jobs/streaming-url-remediation/logger.ts verbatim — the contract is
 * identical, the duplication keeps this job's build graph independent of the
 * sibling job packages.
 */
