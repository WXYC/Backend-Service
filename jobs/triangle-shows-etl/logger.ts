 ...
 *
 * Mirrors `jobs/venue-events-scraper/logger.ts` verbatim — the contract
 * from issue #538 is identical, the duplication is to keep this cron
 * job's build graph independent of the long-running services.
 */
