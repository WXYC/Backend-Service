/**
 * Concurrency + rate-limit gate for jobs/rotation-release-id-backfill (BS#1029).
 *
 * Mirrors jobs/flowsheet-metadata-backfill/lml-limiter.ts verbatim — same
 ...
 * keeps the rotation-release-id-backfill's blast-radius story identical
 * to the metadata cron's, without coupling either to the other's build
 * graph.
 *
