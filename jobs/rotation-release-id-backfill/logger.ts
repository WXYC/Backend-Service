/**
 * Observability for jobs/rotation-release-id-backfill (BS#1029): Sentry init
 * + JSON logs.
 *
 ...
 * contract is identical, the duplication is to keep this one-shot job's
 * build graph independent of the metadata cron's package.
 */
