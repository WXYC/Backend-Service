...
Every FK referencing `library.id` is repointed to the survivor **before** the losing row is deleted. That is not stylistic. Of the 14 reference sites, seven cascade and two null out the reference:
