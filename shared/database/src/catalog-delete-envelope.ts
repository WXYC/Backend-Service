...
// `RESTORABLE_ENTITY_KINDS` / `isRestorableEntityKind` (BS#2616) used to live
// here, but moved to `apps/backend/services/library.service.ts` in the BS#2616
// follow-up review (finding 10): this module's own docstring above disclaims
// any opinion about restore semantics, and a restore-policy constant living
