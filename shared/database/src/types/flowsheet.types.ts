...
/** Request body for adding a track entry */
export interface AddTrackRequestV2 {
  artist_name?: string;
  album_title?: string;
  track_title: string;
  album_id?: number;
...
/** Request body for adding a talkset entry */
export interface AddTalksetRequestV2 {
  message: string;
}

/** Request body for adding a breakpoint entry */
export interface AddBreakpointRequestV2 {
  message?: string;
}

/** Request body for adding a custom message entry */
export interface AddMessageRequestV2 {
  message: string;
}
