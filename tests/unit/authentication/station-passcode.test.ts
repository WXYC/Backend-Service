...
// canonicalizeStationSignupClientIp / deriveStationSignupIpHash moved to
// tests/unit/authentication/signup-ip-hash.test.ts (BS#2537, parent epic
// #2534 decision 8) alongside their source's move to signup-ip-hash.ts.
